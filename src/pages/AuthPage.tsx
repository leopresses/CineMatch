        ...
        >
          ...
          {mode !== "forgot" && (
            <>
              ...
              <div className="space-y-2.5">
                <button className="w-full flex items-center justify-center gap-3 h-12 rounded-xl border border-border font-medium text-sm hover:bg-secondary transition-colors touch-target">
          ...
          {mode !== "forgot" && (
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground touch-target flex items-center justify-center"
              >
          ...
          {mode === "login" && (
            <button
              ...
              className="text-xs text-accent font-medium w-full text-right"
            >
              Esqueci minha senha
            </button>
          )}
          ...
          {/* Submit */}
          <button className="w-full btn-gold text-base h-12">
          ...
          <p className="text-center text-sm text-muted-foreground">
            {mode === "login" ? (
              <>
                Não tem conta?{" "}
                <button onClick={() => setMode("signup")} className="text-accent font-medium">
                  Criar conta
                </button>
              </>
            ) : (
              <>
                Já tem conta?{" "}
                <button onClick={() => setMode("login")} className="text-accent font-medium">
                  Entrar
                </button>
              </>
            )}
